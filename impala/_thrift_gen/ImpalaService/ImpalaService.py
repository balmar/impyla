    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                ...
                if ftype == TType.STRUCT:
                    self.error = impala._thrift_gen.beeswax.ttypes.BeeswaxException.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                ...
                if ftype == TType.STRUCT:
                    self.error = impala._thrift_gen.beeswax.ttypes.QueryNotFoundException.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.STRUCT:
                    self.error2 = impala._thrift_gen.beeswax.ttypes.BeeswaxException.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)

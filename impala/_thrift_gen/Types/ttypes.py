...
class TNetworkAddress(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.uds_address = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.uds_address is not None:
            ...
            oprot.writeString(self.uds_address.encode('utf-8') if sys.version_info[0] == 2 else self.uds_address)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
TNetworkAddress.thrift_spec = (
    ...
    (3, TType.STRING, 'uds_address', 'UTF8', None, ),  # 3
)

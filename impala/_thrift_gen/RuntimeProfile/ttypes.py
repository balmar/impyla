            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i210 in range(_size206):
                        _elem211 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
...
TAggEventSequence.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'name', 'UTF8', None, ),  # 1
    (2, TType.LIST, 'label_dict', (TType.STRING, 'UTF8', False), None, ),  # 2
...
TAggregatedRuntimeProfileNode.thrift_spec = (
    ...
    (2, TType.LIST, 'input_profiles', (TType.STRING, 'UTF8', False), None, ),  # 2
    (3, TType.LIST, 'counters', (TType.STRUCT, [TAggCounter, None], False), None, ),  # 3
    (4, TType.MAP, 'info_strings', (TType.STRING, 'UTF8', TType.MAP, (TType.STRING, 'UTF8', TType.LIST, (TType.I32, None, False), False), False), None, ),  # 4
